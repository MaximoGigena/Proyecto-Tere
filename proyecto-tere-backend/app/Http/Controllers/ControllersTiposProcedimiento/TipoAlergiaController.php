    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'areas_afectadas.*' => ['string', Rule::in(['piel', 'ojos', 'oidos', 'respiratorio', 'digestivo', 'neurologico', 'otro'])],
                'otra_area' => 'string|max:255|nullable',
                'tratamiento_recomendado' => 'string|nullable',
                'recomendaciones_clinicas' => 'string|nullable',
                'especie_afectada' => ['required', Rule::in(['canino', 'felino', 'ave', 'roedor', 'exotico', 'todos'])],
                ...
                'especie_afectada.required' => 'La especie afectada es obligatoria.',
            ...
            $tipoAlergia = TipoAlergia::create([
                ...
                'especie_afectada' => $request->especie_afectada,
