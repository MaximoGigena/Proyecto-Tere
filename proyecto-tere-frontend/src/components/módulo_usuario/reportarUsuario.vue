...
const causasEspecificas = {
  'Comportamiento inapropiado': ['Lenguaje ofensivo', 'Acoso o bullying', 'Discriminación','Otro'],
  'Perfil falso': ['Fotos robadas', 'Fotos/Videos generadas por IA', 'Información falsa','Otro'],
  ...
  'Spam o publicidad': ['Promociona un producto', 'Enlaces sospechosos', 'Mensajes repetitivos', 'Otro'],
}
