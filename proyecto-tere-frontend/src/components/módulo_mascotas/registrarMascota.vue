    ...
    <form @submit.prevent="esEdicion ? actualizarMascota() : registrarMascota()" class="space-y-4">
      ...
      <div class="pt-4 flex justify-end items-center gap-4">
        ...
        <button
          ...
          :disabled="cargando"
          :class="[
            'bg-red-500 text-white px-4 py-2 rounded-full flex items-center gap-2 transition-colors',
            cargando 
        ...
        <button
          ...
          :disabled="cargando"
          :class="[
            'bg-blue-500 text-white px-4 py-2 rounded-full transition-colors',
            cargando 
              ? 'opacity-50 cursor-not-allowed' 
              : 'hover:bg-blue-700'
          ]"
        >
          <span v-if="cargando" class="flex items-center gap-2">
            ...
            {{ esEdicion ? 'Actualizando...' : 'Registrando...' }}
          </span>
          <span v-else>
