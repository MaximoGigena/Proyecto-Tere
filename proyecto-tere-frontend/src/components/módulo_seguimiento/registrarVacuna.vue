    ...
    <form @submit.prevent="registrarVacunacion" class="space-y-4">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="space-y-4">
          <div>
            ...
            <input v-model="vacuna.tipo" type="text" required class="w-full border rounded p-2" placeholder="Ej: Rabia, Moquillo, etc." />
          </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
        ...
        <div class="col-span-full">
          ...
          <textarea v-model="vacuna.observaciones" rows="4" maxlength="500" class="w-full border rounded p-2 resize-none"></textarea>
          <p class="text-sm text-gray-500 text-right mt-1">{{ vacuna.observaciones.length }}/500 caracteres</p>
        </div>
      </div>
